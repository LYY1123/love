...
let moduleConfig = {
  ...
  plugins : [
    new ImageminPlugin({
      disable : process.env.DEV_ENV.replace(/\s/,'') !== 'build',
    ...
    new AddAssetHtmlPlugin({ 
      ...
      publicPath : process.env.DEV_ENV.replace(/\s/,'') == 'build' ? '/love/lib' : '/lib',  //HTML中引入公共第三方js的路径链接
    }),
...
if(process.env.DEV_ENV.replace(/\s/,'') == 'build'){
  moduleConfig.output.publicPath = "/love/"
}else{
